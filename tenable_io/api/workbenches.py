...
class WorkbenchesApi(BaseApi):
    ...
    def export_request(
        ...
        :param chapter: Chapter to include, one of CHAPTER_DIFF, CHAPTER_EXEC_SUMMARY, CHAPTER_VULN_BY_ASSET,
            CHAPTER_VULN_BY_PLUGIN, CHAPTER_VULN_HOSTS_SUMMARY.
        ...
        assert chapter in [WorkbenchesApi.CHAPTER_DIFF, WorkbenchesApi.CHAPTER_EXEC_SUMMARY,
                           WorkbenchesApi.CHAPTER_VULN_BY_ASSET, WorkbenchesApi.CHAPTER_VULN_BY_PLUGIN,
                           WorkbenchesApi.CHAPTER_VULN_HOSTS_SUMMARY, ], u'Valid chapter.'
        ...
        if filters:
            for i in xrange(len(filters)):
                for k in filters[i]:
                    params[u'filter.%d.%s' % (i, k)] = filters[i][k]
